...
private void simpanLogLogin(String username, String status, String role, Connection conn) {
    try {
        String sqlLog = "INSERT INTO log_login (username, login_time, status, akses) VALUES (?, NOW(), ?, ?)";
        PreparedStatement pstLog = conn.prepareStatement(sqlLog);
        pstLog.setString(1, username);
        pstLog.setString(2, status);
        pstLog.setString(3,role);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (dbHashedPassword.equals(inputHashed)) {
            ...
            simpanLogLogin(username, "sukses", role, conn);
            ...
            simpanLogLogin(username, "gagal", role, conn);
        }
        } else {
            JOptionPane.showMessageDialog(this, "Username tidak ditemukan!");
            simpanLogLogin(username, "gagal", null, conn);
        }
