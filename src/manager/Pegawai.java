...
private void tampilkanDataPegawai() {
    ...
    private void initComponents() {
        ...
        jButton6.setBackground(new java.awt.Color(173, 181, 189));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try (Connection conn = DatabaseConnection.connect()) {
        String sql = "UPDATE pegawai SET nama_pegawai = ?, nik = ?, jenis_kelamin = ?, alamat = ?, no_tlp = ?, email = ?, jabatan = ?, akses_sistem = ? WHERE id_pegawai = ?";
        PreparedStatement stmt = conn.prepareStatement(sql);
