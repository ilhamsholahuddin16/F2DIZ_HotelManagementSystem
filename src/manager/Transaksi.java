...
public class Transaksi extends javax.swing.JFrame {
    ...
    public Transaksi() {
        ...
        if (row != -1) {
            String id_reservasi = jTable2.getValueAt(row, 1).toString();
            jTextField5.setText(id_reservasi);
            String lama = jTable2.getValueAt(row, 2).toString();
            jTextField7.setText(lama);
            String pembayaran = jTable2.getValueAt(row, 3).toString();
            jComboBox1.setSelectedItem(pembayaran);
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jButton4, javax.swing.GroupLayout.DEFAULT_SIZE, 377, Short.MAX_VALUE))))
                .addContainerGap())
        );
...
//                "SELECT id, username, akses FROM users WHERE username LIKE ?"
    ...
    String idTransaksi = jTextField1.getText().trim();     
    String idReservasi = jTextField5.getText().trim();   
    String totalStr = jTextField7.getText().trim();        
    String pembayaran = (String) jComboBox1.getSelectedItem();  
    Date tanggalTransaksi = jDateChooser3.getDate();       
    ...
    if (idReservasi.isEmpty() || totalStr.isEmpty() || pembayaran == null || tanggalTransaksi == null || status == null) {
        JOptionPane.showMessageDialog(this, "Semua field wajib diisi!");
        return;
    }
    ...
    try (Connection conn = DatabaseConnection.connect()) {
    String sql = "UPDATE transaksi SET total = ?, pembayaran = ?, tanggal_transaksi = ?, status_transaksi = ? WHERE id_reservasi = ?";
    PreparedStatement stmt = conn.prepareStatement(sql);

    stmt.setDouble(1, total);
    stmt.setString(2, pembayaran);
    stmt.setString(3, tanggalFormatted);
    stmt.setString(4, status);
    stmt.setString(5, idReservasi);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int idTransaksi = (int) jTable2.getValueAt(selectedRow, 0);
        ...
        jDateChooser3.setDate(null);
            ...
            JOptionPane.showMessageDialog(this, "Gagal menghapus data Transaksi: " + ex.getMessage());
            ex.printStackTrace();
            }
        }
